...
tiff(file = "North Site (min,mean,max)_cleaned8.tiff", height = 6, width = 10, res = 600, units = "in", compression = "zip+p")
...
rect(xleft = as.Date("2019-10-21"), xright = as.Date("2019-10-25"), ybottom = -999, ytop = 999, col = "grey80", bty = "n", border = F)
rect(xleft = as.Date("2019-12-15"), xright = as.Date("2019-12-19"), ybottom = -999, ytop = 999, col = "grey80", bty = "n", border = F)
rect(xleft = as.Date("2020-02-08"), xright = as.Date("2020-02-12"), ybottom = -999, ytop = 999, col = "grey80", bty = "n", border = F)
rect(xleft = as.Date("2020-04-04"), xright = as.Date("2020-04-08"), ybottom = -999, ytop = 999, col = "grey80", bty = "n", border = F)
rect(xleft = as.Date("2020-06-09"), xright = as.Date("2020-06-13"), ybottom = -999, ytop = 999, col = "grey80", bty = "n", border = F)
rect(xleft = as.Date("2020-07-25"), xright = as.Date("2020-07-29"), ybottom = -999, ytop = 999, col = "grey80", bty = "n", border = F)
box()

dat<-subset(df, Site == "BM" & Trt == "C")
...
mtext(side = 2, expression(degree*C), cex = 1.2, padj = -2.0, outer= F)
...
mtext(side = 2, expression("VPD_kPa"), cex = 1.5, padj = -1.25, outer= F)
legend("bottomleft", c("(c)"), bty = "n")

mtext(side = 1, expression("Time"), cex = 2, padj = 2, outer = T)
